...
vlcPlayer = vlc.MediaPlayer("file:///home/michael/Trichter.mp3")
...
def play_trichter():
	...
	os.system("/home/michael/stop.sh > /dev/null")
	vlcPlayer.play()
...
def restore_trash():
	...
	vlcPlayer.pause()
	os.system("/home/michael/start.sh > /dev/null")
